    ...
    >
      ...
      <div className="pt-12 grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
        {events.map((event, idx) => (
          <div
            key={event.name + idx}
            className="flex flex-col gap-5 w-full max-w-sm text-2xl md:text-xl lg:text-lg xl:text-2xl text-center font-bold items-center bg-[#00458f] hover:bg-[#003b7a] p-8 rounded-md aspect-square"
          >
            <div className="self-center mt-8 md:mt-4">
